...
upgrades = {
	...
	skynetlorad = {
		blue = {'blueSHORAD'},
		red = {'SAM-SA2-redLORAD','SAM-SA2-redLORAD','SAM-SA2-redLORAD','SAM-SA2-redLORAD','SAM-SA2-redLORAD'}
	},
	sa5 = {
	...
	skynetewr1 = {
		blue = {'blueInfantry'},
		red = {'EWR-red1','redSHORAD'}
	},
	skynetewr2 = {
		blue = {'blueInfantry'},
		red = {'EWR-red2','redSHORAD'}
	},
	milbase = {
...
flavor = {
	...
	radio = 'WPT 35\nStrike target, can not be captured, destroy for 500 credits',
	gaziantep = 'WPT x\nTestArea for SkynetIADS SAM',
	ewrwest = 'WPT y\nTestArea for SkynetIADS EWR',
	ewreast = 'WPT y\nTestArea for SkynetIADS EWR',
}
...
zones = {
	...
	gaziantep = ZoneCommander:new({zone='Gaziantep', side=1, level=4,upgrades=upgrades.skynetlorad, crates={}, flavorText=flavor.gaziantep}),
	ewreast = ZoneCommander:new({zone='EWREast', side=1, level=5,upgrades=upgrades.skynetewr2, crates={}, flavorText=flavor.ewreast}),
	ewrwest = ZoneCommander:new({zone='EWRWest', side=1, level=5,upgrades=upgrades.skynetewr1, crates={}, flavorText=flavor.ewrwest}),
}
...
zones.gaziantep:addCriticalObject('ccSkynet-1')
zones.gaziantep:addCriticalObject('commsSkynet1')
...
zones.gaziantep:registerTrigger('destroyed', function(event, sender) 
	sender:disableZone()
	bc:addFunds(2,500)
	trigger.action.outTextForCoalition(2,'SKYNET DESTROYED... DA DA DA DA DAN...',20)
end, 'disableGaziantep')
